...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--tau_gamma', type=float, default=0.99,
    ...
    parser.add_argument('--info_nce_chunk_size', type=int, default=1024,
    ...
    parser.add_argument('--u2u_weight', type=float, default=1.0,
                        help='Initial weight for the u2u Barlow Twins loss term.')
    parser.add_argument('--i2i_weight', type=float, default=1.0,
    ...
    parser.add_argument('--w_ema_update_interval', type=int, default=5,
                        help='Update W_ema every N training steps (0 = never update).')

    # Soft topology-aware purification (TEX §3.4, §4.2)
    parser.add_argument('--soft_purification_percentile', type=float, default=0.8,
    ...
    parser.add_argument('--soft_purification_temp', type=float, default=0.2,
