...
\begin{lstlisting}[language=Python]
args.g_layers              = cfg.g_layers
args.warmup_epochs         = cfg.warmup_epochs
args.delay_hard_negs_epoch = cfg.delay_hard_negs_epoch if cfg.enable_delayed_faiss else 0
args.vicreg_hidden_dim     = cfg.vicreg_hidden_dim
args.vicreg_projector_dim  = cfg.vicreg_projector_dim
args.enable_svd_spectral   = cfg.enable_svd_spectral
args.svd_top_k             = cfg.svd_top_k

projector = ExpandedProjector(
    input_dim=64,
    hidden_dim=cfg.vicreg_hidden_dim,
    output_dim=cfg.vicreg_projector_dim
).cuda()

hybrid_balancer = HybridLossBalancer(
    num_tasks=cfg.n_tasks,
    mode=cfg.balancer_type,
    switch_epoch=cfg.balancer_switch_epoch
).cuda()
\end{lstlisting}
